...
%   - layout_conn_type: Connection types of the components in layout.
%   - layout_model: Simulink model (so that any leftover saved file from
%   previous iterations can be deleted)
